      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!isAdmin ? (
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Use "admin123" para acessar o painel (apenas para demonstração)
                </p>
              </div>
          ...
          <div className="space-y-8">
            <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
              <h2 className="text-xl font-semibold mb-4">Selecione um baralho</h2>
            ...
            {selectedDeck && (
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
                <h2 className="text-xl font-semibold mb-2">{selectedDeck.name}</h2>
                <p className="text-muted-foreground mb-6">{selectedDeck.description}</p>

                <Tabs defaultValue="black" className="w-full">
                  <TabsList className="grid grid-cols-2 mb-6">
                    <TabsTrigger value="black">Cartas Pretas ({selectedDeck.blackCards.length})</TabsTrigger>
                    <TabsTrigger value="white">Cartas Brancas ({selectedDeck.whiteCards.length})</TabsTrigger>
                  </TabsList>
                  
                  <TabsContent value="black" className="space-y-6">
                    <div>
                      <label htmlFor="newBlackCard" className="block text-sm font-medium mb-1">
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <Button 
                                variant="ghost" 
                                size="icon"
                                onClick={() => removeCard(selectedDeck.id, card.id, "black")}
                              >
                  ...
                  <TabsContent value="white" className="space-y-6">
                    <div>
                      <label htmlFor="newWhiteCard" className="block text-sm font-medium mb-1">
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <Button 
                                variant="ghost" 
                                size="icon"
                                onClick={() => removeCard(selectedDeck.id, card.id, "white")}
                              >
                                <Trash2 className="h-4 w-4" />
                              </Button>
                            </div>
